...
namespace Nop.Plugin.Api.DTOs.Products
{
    ...
    public class ProductDto : BaseDto
    {
        ...
        private List<ProductAttributeCombinationDto> _productAttributeCombination;
        /// <summary>
        ...
        [JsonProperty("attributes_combination")]
        public List<ProductAttributeCombinationDto> ProductAttributeCombination
        {
            get
            {
                return _productAttributeCombination;
            }
            set
            {
                _productAttributeCombination = value;
            }
        }

        [JsonProperty("attributes_combination_error")]
        public List<string> AttributesCombinationError { get; set; }
    }
}