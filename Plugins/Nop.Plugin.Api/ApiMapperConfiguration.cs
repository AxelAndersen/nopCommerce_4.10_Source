...
namespace Nop.Plugin.Api
{
    public class ApiMapperConfiguration : Profile, IOrderedMapperProfile
    {
        public ApiMapperConfiguration()
        {
            ...
            CreateSpecificationAttributeEntityToSpecificationAttributeDtoMap();
        ...
        private void CreateSpecificationAttributeEntityToSpecificationAttributeDtoMap()
        {
            AutoMapperApiConfiguration.MapperConfigurationExpression.CreateMap<SpecificationAttribute, SpecificationAttributeDto>()
                .IgnoreAllNonExisting()
                .ForMember(x => x.Id, y => y.MapFrom(src => src.Id))
                .ForMember(x => x.SpecificationAttributeOptions, y => y.MapFrom(src => src.SpecificationAttributeOptions.Select(x => x.ToDto())));
        }
    }
}